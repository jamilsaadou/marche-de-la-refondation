...
export const metadata: Metadata = {
  title: "Marché de la Réfondation | Niger 2026",
  description: "Plateforme d'information sur le Marché de la Réfondation - Valorisation et Commercialisation des Produits Locaux dans le cadre du Centenaire de Niamey (2026)",
